...
exports.formCrearCuenta = async(req, res,next)=>{
    ...
    res.render('crearCuenta',{
        nombrePagina:'Crear Cuenta de Tareas'
    })
...
exports.crearCuenta =async(req, res, next)=>{
    ...
    try {
        ...
        req.flash('correcto', 'Se envio un mensaje a tu correo para activar la cuenta');
...
exports.confirmarCuenta = async(req, res)=>{
    ...
    if(!usuario){
        req.flash('error', 'No valido!! pongase en contacto con el administrador');
